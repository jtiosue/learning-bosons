...
a = [
    ...
    BosonicPoly.create_var("a2"),
]
a0, a1, a2 = a
adag = [
    BosonicPoly.create_var("adag0"),
    BosonicPoly.create_var("adag1"),
    BosonicPoly.create_var("adag2"),
]
a0dag, a1dag, a2dag = adag
...
psi0 = BosonicPoly() + 1
psi1 = (1 / 2) * a1dag**2 * a2dag**2 + (np.sqrt(3) * a1dag + np.sqrt(2) * a2dag)
psi2 = (1 / 2) * a1dag**2 * a2dag**2 + (np.sqrt(1) * a1dag + np.sqrt(4) * a2dag)
...
print()
print("|22> + sqrt(3) |10> + sqrt(2) |01>")
print(coveig(covSigma_1))
print()
print("|22> + sqrt(1) |10> + sqrt(4) |01>")

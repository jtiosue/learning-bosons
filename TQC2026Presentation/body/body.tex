\begin{frame}[noframenumbering,plain]
  ...
  \absolutePos{8cm}{6cm}{\textbf{TQC 2026}}
  \absolutePos{8cm}{7.4cm}{\includegraphics[height=.3\textheight]{graphics/logo-2026.png}}
...
\begin{frame}{Summary}
  \begin{spaceditemize}
    \item B using higher moments, we found a \textbf{sample and time efficient} algorithm to learn \emph{BosonSampling states}
...
\begin{frame}{Thanks to my collaborators}
  \begin{minipage}{.32\textwidth}
    \begin{spaceditemize}[.25em]
      \item Yuxin Wang
      \item Alexey Gorshkov
      \item Changhun Oh
      \item Bill Fefferman
      \item Soumik Ghosh
      \item Ishaun Datta
